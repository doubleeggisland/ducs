...
public interface TenantUserR2RoleSlaveDbSvc
        extends IBaseDeiSlaveDbService<TenantUserR2Role> {

    Map<Long, List<Long>> getGroupedRoleIds(final List<Long> tenantUserIds);
    Map<Long, List<Long>> getGroupedTenantUserIds(final List<Long> roleIds);
}
