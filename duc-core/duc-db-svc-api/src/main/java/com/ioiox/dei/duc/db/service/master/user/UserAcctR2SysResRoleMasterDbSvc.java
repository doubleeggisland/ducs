...
public interface UserAcctR2SysResRoleMasterDbSvc
        extends IBaseDeiMasterDbService<UserAcctR2SysResRole> {
    int save(final List<Long> sysResRoleSids, final Long userAcctSid, final String operator, final Date operateTime);
}
