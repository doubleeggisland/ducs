...
import com.ioiox.dei.duc.beans.vo.std.slave.UserGrpQueryParam;
import com.ioiox.dei.duc.beans.vo.std.slave.UserGrpQueryParamBuilder;
...
public class AcctUserGrpQueryParam
        extends UserGrpQueryParam {
    private List<Long> corpIds;
    private List<Long> tenantIds;

    private AcctUserGrpQueryParam(final Builder builder) {
        super(builder);
    ...
    public static class Builder
            extends UserGrpQueryParamBuilder<AcctUserGrpQueryParam> {
        private List<Long> corpIds;
        private List<Long> tenantIds;
        ...
        @Override
        public AcctUserGrpQueryParam build() {
            return new AcctUserGrpQueryParam(this);
        }
    }
}
