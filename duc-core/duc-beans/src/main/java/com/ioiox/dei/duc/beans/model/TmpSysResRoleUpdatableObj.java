...
@Setter
@NoArgsConstructor
public abstract class TmpSysResRoleUpdatableObj
        extends SysResRoleUpdatableObj {
    ...
    public Map<String, String> updateSummary() {
        final Map<String, String> updateSummary = new HashMap<>(SysResRole.ShowColumn.values().length + TmpSysResRole.ShowColumn.values().length);
