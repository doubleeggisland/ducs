...
public class TenantUserGrpQueryParam
        extends UserGrpQueryParam {
    private List<Long> tenantIds;

    private TenantUserGrpQueryParam(final Builder builder) {
        super(builder);
    ...
    public static class Builder
            extends UserGrpQueryParamBuilder<TenantUserGrpQueryParam> {
        private List<Long> tenantIds;
        ...
        @Override
        public TenantUserGrpQueryParam build() {
            return new TenantUserGrpQueryParam(this);
        }
    }
}
