...
import com.ioiox.dei.duc.db.mapper.slave.employee.EmployeeTmpRoleR2MenuSysApiSlaveMapper;
...
@Service("employeeTmpRoleR2MenuSysApiSlaveDbSvc")
public class EmployeeTmpRoleR2MenuSysApiSlaveDbSvcImpl
        extends BaseDeiRelationshipEntitySlaveDbSvc<Long, Long, RoleR2MenuSysApi, EmployeeTmpRoleR2MenuSysApiSlaveMapper>
        implements EmployeeTmpRoleR2MenuSysApiSlaveDbSvc {

    @Autowired
    private EmployeeTmpRoleR2MenuSysApiSlaveMapper mapper;
    ...
    @Override
    protected EmployeeTmpRoleR2MenuSysApiSlaveMapper getMapper() {
        return mapper;
    }
