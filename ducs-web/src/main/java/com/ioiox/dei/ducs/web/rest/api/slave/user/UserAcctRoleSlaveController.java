...
public class UserAcctRoleSlaveController {
    ...
    public DeiResponseData<List<UserAcctRoleSlaveVO>> queryRoles(@RequestBody final UserAcctRoleQueryReq queryReq) {
        return new DeiResponseData.Builder<List<UserAcctRoleSlaveVO>>()
                .code(DeiResponseData.SUCCESS)
                .success(DeiGlobalConstant.TRUE_STR)
